module.exports = {
  title: 'Vue Storefront 2 for orca',
  base: '/',
  description: 'Documentation for the orca connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/orca',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/orca'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/orca'}
    ],
    sidebar: [
      {
        title: 'Essentials',
