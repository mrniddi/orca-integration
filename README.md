...
```sh
grep -rl 'orca' ./ | xargs sed -i '' 's/orca/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with orca
...
Want to contribute? Ping us on `orca` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/orca.git
    cd orca
    ```
...
- [orca integration Documentation](https://docs.vuestorefront.io/orca)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `orca` channel on [our Discord](discord.vuestorefront.io).
